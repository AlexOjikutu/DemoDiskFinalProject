...
namespace DemoDisk
{
    public partial class PongGamevsCPU : Form
    {
       ...
       //bool player2moveUp;
        ...
        private void pongTimer_Tick(object sender, EventArgs e)
        {
            ...
            if (ball.Top > player2.Top + (player2.Height / 2) && player2.Top < bounds)
            {
                player2.Top += 4;
            ...
            if (ball.Top < player2.Top + (player2.Height / 2) && player2.Top > 0)
            {
                player2.Top -= 3;
        ...
        private void PongGamevsCPU_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void PongGamevsCPU_KeyUp(object sender, KeyEventArgs e)
        {
